        ...
        <div className="w-full max-w-lg space-y-10">
             ...
             <>
               <div className="space-y-5">
                  <div className="relative">
                    ...
                    <input type="text" placeholder="Correo" className="w-full pl-14 pr-6 py-6 bg-white dark:bg-slate-800 border border-gray-100 dark:border-slate-700 rounded-xl outline-none focus:ring-4 focus:ring-blue-100 dark:text-white transition-all text-lg"/>
                  </div>
                  <div className="relative">
                    <Lock size={24} className="absolute left-5 top-1/2 -translate-y-1/2 text-gray-400"/>
                    <input type="password" placeholder="Clave" className="w-full pl-14 pr-6 py-6 bg-white dark:bg-slate-800 border border-gray-100 dark:border-slate-700 rounded-xl outline-none focus:ring-4 focus:ring-blue-100 dark:text-white transition-all text-lg"/>
                  </div>
               </div>
               <div className="space-y-4">
                 <button onClick={() => onLogin('admin')} className="w-full bg-blue-600 text-white py-6 rounded-xl font-bold text-xl hover:bg-blue-700 shadow-2xl flex items-center justify-center gap-3 transition-transform hover:scale-[1.02] active:scale-[0.98]">
                   Ingresar <ArrowRightCircle size={28}/>
                 </button>
                 <button onClick={() => setView('parent-dni')} className="w-full bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-200 border border-slate-200 dark:border-slate-700 py-6 rounded-xl font-bold text-xl hover:bg-slate-50 dark:hover:bg-slate-700 shadow-sm flex items-center justify-center gap-3 transition-transform hover:scale-[1.02] active:scale-[0.98]">
                  ...
                  <>
                    <div className="relative">
                      ...
                      <input 
                        ...
                        className="w-full pl-14 pr-6 py-6 bg-white dark:bg-slate-800 border border-gray-100 dark:border-slate-700 rounded-xl outline-none focus:ring-4 focus:ring-blue-100 dark:text-white transition-all text-lg"
                      />
                    </div>
                    <button onClick={handleDniSubmit} className="w-full bg-blue-600 text-white py-6 rounded-xl font-bold text-xl hover:bg-blue-700 shadow-2xl flex items-center justify-center gap-3 transition-transform hover:scale-[1.02] active:scale-[0.98]">
           ...
           {view === 'parent-phone' && (
             <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
                ...
                <button onClick={handlePhoneSubmit} className="w-full bg-[#25D366] text-white py-6 rounded-xl font-bold text-xl hover:bg-[#128C7E] shadow-2xl flex items-center justify-center gap-3 transition-transform hover:scale-[1.02] active:scale-[0.98]">
             ...
             <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full pl-14 pr-6 py-6 bg-white dark:bg-slate-800 border border-gray-100 dark:border-slate-700 rounded-xl outline-none focus:ring-4 focus:ring-blue-100 dark:text-white transition-all text-lg text-center tracking-widest font-mono"
                    maxLength={6}
                  />
                </div>
                <button onClick={handleCodeSubmit} className="w-full bg-blue-600 text-white py-6 rounded-xl font-bold text-xl hover:bg-blue-700 shadow-2xl flex items-center justify-center gap-3 transition-transform hover:scale-[1.02] active:scale-[0.98]">

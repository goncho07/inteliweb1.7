...
import { MessageSquare, Search, Send, Mic, Calendar, AlertTriangle, CheckCircle2, Clock, FileText, Plus, X, MoreVertical, Lock, Sparkles, CheckCheck, MessageCircle } from 'lucide-react';

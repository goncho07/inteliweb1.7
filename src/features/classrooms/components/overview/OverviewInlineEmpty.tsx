...
export const OverviewInlineEmpty: React.FC<{ title: string; description: string; icon?: LucideIcon }> = ({
  ...
  <div className="m-6 flex flex-col items-center justify-center gap-2 rounded-xl border border-dashed border-slate-200 bg-white p-8 text-center dark:border-slate-800 dark:bg-slate-900">

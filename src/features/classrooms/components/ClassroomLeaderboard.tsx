...
import { Search, MoreVertical, AlertTriangle, Clock, Trophy, FileText, Activity, Users, ShieldAlert, FolderOpen } from 'lucide-react';
...
export const ClassroomLeaderboard = ({ classroom, onReportClick }: { classroom: { level: string; grade: string; section: string }, onReportClick?: () => void }) => {
  ...
  const sortedStudents = useMemo(() => {
     const sorted = [...studentsWithStats];
  ...
  return (
    <div className="flex flex-col h-full bg-[#EFEAE2] dark:bg-[#0b141a] overflow-hidden animate-in fade-in slide-in-from-right-4 duration-500">
